        ...
        <div className="px-6 py-4 border-t border-[#E9E1D0] flex items-center gap-2">
          {onDelete && (
            <button
              onClick={onDelete}
              disabled={saving}
              className="px-4 py-2 text-xs font-medium text-[var(--terra-500)] hover:bg-[#FCE0E2] rounded-lg disabled:opacity-50"
            >Eliminar</button>
          )}
          ...
          <button
            ...
            className="px-4 py-2 text-xs font-medium bg-[var(--terra-500)] text-white rounded-lg hover:bg-[#901A1E] disabled:opacity-50"
