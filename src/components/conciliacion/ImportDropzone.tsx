  ...
  return (
    <div
      ...
      style={{
        ...
        padding: '10px 18px',
        borderRadius: 10,
        border: `2px dashed ${dragging ? T.brandAccent : T.borderDefault}`,
        backgroundColor: dragging ? T.bgSurface : 'transparent',
        cursor: 'pointer',
    ...
    >
      ...
      {fileName ? (
        <>
          <FileCheck2 size={20} color={T.brandAccent} />
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <span style={{ fontFamily: FONT.sans, fontSize: 11, color: T.textTertiary, textTransform: 'uppercase', letterSpacing: 0.5 }}>
              Archivo cargado
            </span>
            <span style={{ fontFamily: FONT.sans, fontSize: 13, color: T.textPrimary }}>{fileName}</span>
          </div>
        </>
      ) : (
        <>
          <Upload size={20} color={T.brandAccent} />
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <span style={{ fontFamily: FONT.sans, fontSize: 12, color: T.brandAccent, textTransform: 'uppercase', letterSpacing: 0.8, fontWeight: 600 }}>
              Importar extracto
            </span>
