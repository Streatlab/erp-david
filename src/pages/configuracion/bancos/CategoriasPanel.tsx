        ...
        >
          ...
          >
            <div style={{
              ...
              letterSpacing: 1, textTransform: 'uppercase', color: 'var(--terra-500)', marginBottom: 18,
            }}>
              Nueva categoría
            </div>
                ...
                {(['ingreso', 'gasto'] as const).map(t => (
                  <button
                    ...
                    style={{
                      ...
                      cursor: 'pointer',
                      background: form.tipoFila === t ? 'var(--terra-500)' : 'transparent',
            ...
            <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end', marginTop: 20 }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: 'var(--terra-500)', color: '#fff', fontFamily: FONT.heading, fontSize: 12,
