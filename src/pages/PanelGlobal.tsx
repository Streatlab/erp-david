...
import {
  cargarPanel, NOMBRE_MES, setObjetivoDia, setObjetivoMensual,
  ...
  return (
    <div className="-m-4 md:-m-6" style={{ fontFamily: LEX, color: INK, background: ARENA }}>
      ...
      {bundle && (<>
        ...
        {/* BANDA 2 · HERO ÁMBAR — has ingresado */}
        <Banda bg={AMBAR}>
        ...
        {/* BANDA 6 · Ratio + salud (BLANCO 50/50) */}
        <Banda bg={BLANCO}>
        ...
        {/* BANDA 8 · Presupuestos del mes (BLANCO) */}
